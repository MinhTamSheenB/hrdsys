object Formfhrd206: TFormfhrd206
  Left = 100
  Top = 136
  Width = 878
  Height = 576
  ...
  object ADOQuery1: TADOQuery
    ...
    Parameters = <>
    SQL.Strings = (
      'select * from hrd_dut_over where emp_id=-1')
    Left = 200
    ...
    object ADOQuery1hour_s: TStringField
      FieldName = 'hour_s'
      Size = 4
    end
    object ADOQuery1hour_e: TStringField
      FieldName = 'hour_e'
      Size = 4
    end
  ...
  object ADOQuery2: TADOQuery
    ...
    SQL.Strings = (
        ...
        'select A.emp_id,A.emp_name,A.dept_code,B.dept_code+'#39'-'#39'+B.abbr_ti' +
        'tl as dept_name from fhrd_emp as A,hrd_dept as B where A.dept_co' +
        'de=B.dept_code ')
    Left = 269
    Top = 5
  end
