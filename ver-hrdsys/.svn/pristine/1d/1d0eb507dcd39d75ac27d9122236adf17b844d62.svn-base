object FormDut13: TFormDut13
  ...
  object qry_mon_Q: TADOQuery
    ...
    AfterOpen = qry_mon_QAfterOpen
    AfterClose = qry_mon_QAfterClose
    AfterInsert = qry_mon_QAfterInsert
    AfterEdit = qry_mon_QAfterEdit
    BeforePost = qry_mon_QBeforePost
    AfterPost = qry_mon_QAfterPost
    AfterDelete = qry_mon_QAfterDelete
    AfterScroll = qry_mon_QAfterScroll
    Parameters = <
      item
        Name = 'emp_id'
        DataType = ftString
    ...
    SQL.Strings = (
        ...
        'select  *  from  hrd_dut_mon   where  emp_id=:emp_id and dut_mon' +
        '=:dut_mon')
    Left = 5
    Top = 10
    ...
    object qry_mon_Qclas_code: TStringField
      ...
      ReadOnly = True
      Visible = False
      OnChange = qry_mon_Qclas_codeChange
      FixedChar = True
      Size = 2
    end
    ...
    object qry_mon_Qday01: TStringField
      FieldName = 'day01'
      OnSetText = qry_mon_Qday01SetText
      Size = 4
    end
