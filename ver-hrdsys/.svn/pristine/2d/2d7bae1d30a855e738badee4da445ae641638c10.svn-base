object FormDut01: TFormDut01
    ...
    object TntTabSheet1: TTntTabSheet
      ...
      object TntGroupBox2: TTntGroupBox
        ...
        object dbg_emp1: TTntDBGrid
          ...
          TitleFont.Style = []
          OnTitleClick = dbg_emp1TitleClick
          Columns = <
            item
              Expanded = False
              FieldName = 'dept_code'
  ...
  object qry_emp1: TADOQuery
    ...
    CursorType = ctStatic
    AfterScroll = qry_emp1AfterScroll
    Parameters = <>
    Left = 4
    Top = 2
  end
