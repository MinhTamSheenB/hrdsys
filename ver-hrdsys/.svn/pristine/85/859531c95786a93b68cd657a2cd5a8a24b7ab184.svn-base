      ...
      begin
        ...
        begin
          ...
          begin
            ...
            ArrangeDs[j,14]:= '****';
            ArrangeDs[j,15]:= '****';
          end  //停工時段起在上班時段裏 停工時段止在上班時段外 修改下班標準時閒,新增停工時段
          ...
          begin
            ...
            ArrangeDs[j,14]:= '****';
            ArrangeDs[j,15]:= '****';
          end  //停工時段起在上班時段外 停工時段止在上班時段裏  修改上班標準時閒,新增停工時段
          ...
          begin
            ...
            ArrangeDs[j,12]:= '****';
            ArrangeDs[j,13]:= '****';
          end //停工時段在上班時段裏 增加停工，上班時段，修改下班時間
...
begin
  ...
  begin
    for j:=0 to ADsLen-1 do
    begin
      //上班時段在請假時段裏 修改上班時段(刷卡時間及班別),排除公休
      ...
      end  //請假時段起在上班時段裏 請假時段止在上班時段外 修改下班標準時閒，新增請假時段
      ...
      begin
        ...
        ArrangeDs[j,14]:= '****';
        ArrangeDs[j,15]:= '****';
      end  //請假時段起在上班時段外 請假時段止在上班時段裏  修改上班標準時閒，新增請假時段
      ...
      begin
        ...
        ArrangeDs[j,12]:= '****';
        ArrangeDs[j,13]:= '****';
      end //請假時段在上班時段裏 增加請假，上班時段，修改下班時間
