object FormFhrd213: TFormFhrd213
  Left = 145
  Top = 129
  Width = 800
  Height = 510
        ...
        object DBGrid1: TTntDBGrid
          ...
          Columns = <
            ...
            item
              Expanded = False
              FieldName = 'seg_id'
              Title.Caption = 'segament'
              Visible = True
            end
            item
              Expanded = False
              FieldName = 'arr_date'
              Title.Caption = 'tms_date_detail'
              Width = 41
              Visible = True
            end
            item
  ...
  object PanelFlow: TTntPanel
    ...
    object TntGroupBox5: TTntGroupBox
      ...
      object DTPickSdate: TTntDateTimePicker
        ...
        Width = 113
        Height = 21
        Date = 39960.485294050920000000
        Time = 39960.485294050920000000
        ImeName = #20013#25991' (?'#20307') - '#35895#27468#25340#38899'?'#20837#27861
        TabOrder = 6
        OnChange = DTPickSdateChange
        OnExit = DTPickSdateExit
        OnKeyDown = DTPickSdateKeyDown
      end
    end
  ...
  object ADOQuery1: TADOQuery
    ...
    object ADOQuery1arr_date: TDateTimeField
      FieldName = 'arr_date'
    end
    object ADOQuery1money: TFloatField
      FieldName = 'money'
    end
  end
