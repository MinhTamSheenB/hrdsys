object FormSal06: TFormSal06
  ...
  object Panel1: TPanel
    ...
    object PanelFlow: TTntPanel
      ...
      object bbtn_finish: TTntSpeedButton
        Left = 158
        Top = 249
        Width = 65
        Height = 25
      ...
      object TntGroupBox5: TTntGroupBox
        ...
        object Label_s_ask_t: TTntLabel
          Left = 5
          Top = 125
          Width = 100
          Height = 13
        ...
        object Label_e_ask_t: TTntLabel
          Left = 5
          Top = 184
          Width = 100
          Height = 13
        ...
        object DBcb_type: TTntDBComboBox
          Left = 112
          Top = 120
          Width = 120
          Height = 21
  ...
  object ADOQuery1: TADOQuery
    ...
    object ADOQuery1serial_no: TLargeintField
      FieldName = 'serial_no'
      ReadOnly = True
    end
    ...
    object ADOQuery1al_mon: TStringField
      FieldName = 'al_mon'
      FixedChar = True
      Size = 6
    end
    object ADOQuery1al_type: TStringField
      FieldName = 'al_type'
      OnGetText = ADOQuery1al_typeGetText
      OnSetText = ADOQuery1al_typeSetText
      FixedChar = True
      Size = 1
    end
    object ADOQuery1al_money: TBCDField
      FieldName = 'al_money'
      Precision = 19
    end
    object ADOQuery1al_reason: TWideStringField
      FieldName = 'al_reason'
      Size = 50
    end
