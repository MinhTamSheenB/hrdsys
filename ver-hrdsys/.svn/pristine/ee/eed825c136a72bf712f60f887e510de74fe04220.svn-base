object FormSal25: TFormSal25
    ...
    object PanelMain: TPanel
      ...
      object PanelAct: TTntPanel
        ...
        object EditExcel: TTntEdit
          ...
          ShowHint = True
          TabOrder = 0
          OnMouseMove = EditExcelMouseMove
        end
  ...
  object ADOQuery1: TADOQuery
    ...
    Parameters = <>
    SQL.Strings = (
      'select top 1 * from hrd_sal_bankcard')
    Left = 200
    Top = 2
    ...
    object ADOQuery1card_no: TStringField
      FieldName = 'card_no'
      Size = 25
    end
    object ADOQuery1bank_name: TWideStringField
      FieldName = 'bank_name'
      Size = 30
    end
  end
  object OpenExcel: TTntOpenDialog
