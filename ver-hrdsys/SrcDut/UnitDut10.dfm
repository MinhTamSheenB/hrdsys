object formDut10: TformDut10
  ...
  object TntPanel7: TTntPanel
    ...
    object dept_begin: TTntComboBox
      Left = 321
      Top = 41
      Width = 168
      Height = 24
      ...
      ParentFont = False
      TabOrder = 4
      OnChange = dept_beginChange
    end
    object dept_end: TTntComboBox
      Left = 495
      Top = 41
      Width = 168
      Height = 24
  ...
  object ADOQuery3: TADOQuery
    ...
    SQL.Strings = (
        ...
        'select a.emp_id,a.emp_chs,b.dept_code+'#39' '#39'+b.abbr_titl as dept  f' +
        'rom hrd_emp a,hrd_dept b where a.dept_code=b.dept_code')
    Left = 344
    Top = 8
  end
  object ADOQuery4: TADOQuery
    ...
    Parameters = <>
    SQL.Strings = (
      'select * from hrd_dut_erhist where 1<0')
    Left = 440
    Top = 8
  end
end
