object FormHrd15: TFormHrd15
  ...
  object ADOQuery1: TADOQuery
    ...
    object ADOQuery1lanu_date: TStringField
      FieldName = 'lanu_date'
      Size = 6
    end
    object ADOQuery1if_card: TStringField
      FieldName = 'if_card'
      Size = 1
    end
    object ADOQuery1epsexd: TStringField
      FieldKind = fkCalculated
      FieldName = 'epsexd'
      OnGetText = ADOQuery1epsexdGetText
      Size = 1
      Calculated = True
    end
  end
