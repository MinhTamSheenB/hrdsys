object FormSal10: TFormSal10
  ...
  object ADOQuery1: TADOQuery
    ...
    object ADOQuery1sal_spec: TFloatField
      FieldKind = fkCalculated
      FieldName = 'sal_spec'
      Calculated = True
    end
    ...
    object ADOQuery1sal_mgmt: TFloatField
      FieldKind = fkCalculated
      FieldName = 'sal_mgmt'
      Calculated = True
    end
    object ADOQuery1sal_tech: TFloatField
      FieldKind = fkCalculated
      FieldName = 'sal_tech'
      Calculated = True
    end
    object ADOQuery1pst_pay: TFloatField
      FieldKind = fkCalculated
      FieldName = 'pst_pay'
      Calculated = True
    end
    object ADOQuery1grade_pay: TFloatField
      FieldKind = fkCalculated
      FieldName = 'grade_pay'
      Calculated = True
    end
    object ADOQuery1sal_achi: TFloatField
      FieldKind = fkCalculated
      FieldName = 'sal_achi'
      Calculated = True
    end
  ...
  object ADODataSet1: TADODataSet
    ...
    CommandText = 'select * from hrd_saltran'
    ...
    object ADODataSet1sal_grade: TStringField
      FieldName = 'sal_grade'
      Size = 4
    end
    object ADODataSet1sal_base: TBCDField
      FieldName = 'sal_base'
      Precision = 19
    end
    object ADODataSet1sal_mgmt: TBCDField
      FieldName = 'sal_mgmt'
      Precision = 19
    end
    object ADODataSet1sal_tech: TBCDField
      FieldName = 'sal_tech'
      Precision = 19
    end
    object ADODataSet1pst_pay: TBCDField
      FieldName = 'pst_pay'
      Precision = 19
    end
    object ADODataSet1envir_pay: TBCDField
      FieldName = 'envir_pay'
      Precision = 19
    end
    object ADODataSet1grade_pay: TBCDField
      FieldName = 'grade_pay'
      Precision = 19
    end
    object ADODataSet1sal_spec: TBCDField
      FieldName = 'sal_spec'
      Precision = 19
    end
    object ADODataSet1sal_achi: TBCDField
      FieldName = 'sal_achi'
      Precision = 19
    end
    object ADODataSet1other_pay: TBCDField
      FieldName = 'other_pay'
      Precision = 19
    end
