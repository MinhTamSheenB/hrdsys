object FormSal23: TFormSal23
  ...
  object Panel1: TPanel
    ...
    object PanelTitle: TTntPanel
      ...
      Align = alTop
      BevelOuter = bvNone
      Caption = #37096#38272#25928#29575#29518#37329#32173#35703
      Color = clCream
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clBlue
      Font.Height = -16
  ...
  object PanelFlow: TTntPanel
    ...
    object TntGroupBox5: TTntGroupBox
      ...
      object Label_e_ask_h: TTntLabel
        ...
        Alignment = taRightJustify
        AutoSize = False
        Caption = #25928#29575#29518#37329
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlue
        Font.Height = -11
        Font.Name = 'MS Sans Serif'
      ...
      object EditFlow0: TTntDBEdit
        ...
        DataSource = DataSource1
        TabOrder = 0
        OnExit = EditFlow0Exit
        OnKeyDown = EditFlow0KeyDown
      end
      object EditFlow3: TTntDBEdit
        Left = 110
        Top = 138
        Width = 100
        Height = 21
  ...
  object ADOQuery1: TADOQuery
    ...
    object ADOQuery1dept_code: TStringField
      FieldName = 'dept_code'
      OnChange = ADOQuery1dept_codeChange
      Size = 6
    end
    ...
    object ADOQuery1eff_per: TBCDField
      FieldName = 'eff_per'
      Precision = 9
      Size = 5
    end
    object ADOQuery1eff_money: TBCDField
      FieldName = 'eff_money'
      Precision = 19
    end
  end
