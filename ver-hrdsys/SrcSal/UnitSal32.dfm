object Formsal32: TFormsal32
    ...
    object PanelMain: TPanel
      ...
      object PanelAct: TTntPanel
        ...
        object Label_path: TTntLabel
          ...
          Alignment = taRightJustify
          AutoSize = False
          Caption = 'Excel '#27284#36335#24465
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlue
          Font.Height = -11
          Font.Name = 'MS Sans Serif'
        ...
        object sbtn_path: TTntSpeedButton
          Left = 223
          Top = 15
          Width = 15
          Height = 22
        ...
        object Btn_excel: TTntButton
          Left = 240
          Top = 13
          Width = 60
          Height = 25
          Caption = #25209#37327#23566#20837
          TabOrder = 1
  ...
  object ADOQuery1: TADOQuery
    ...
    Parameters = <>
    SQL.Strings = (
      'select  * from hrd_sal_mon_spec')
    Left = 200
    Top = 2
    object ADOQuery1up_user: TStringField
      FieldName = 'up_user'
    end
    object ADOQuery1up_date: TDateField
      FieldName = 'up_date'
    end
    object ADOQuery1spc_month: TStringField
      FieldName = 'spc_month'
      Size = 6
    end
    ...
    object ADOQuery1department: TStringField
      FieldKind = fkCalculated
      FieldName = 'department'
      Calculated = True
    end
    object ADOQuery1emp_chs: TStringField
      FieldKind = fkCalculated
      FieldName = 'emp_chs'
      Calculated = True
    end
